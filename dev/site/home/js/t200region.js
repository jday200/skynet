...
regions['asia'] = ['south korea', 'singapore', 'china', 'japan', 'other'];
regions['america'] = ['usa', 'canada', 'other'];
regions['europe'] = ['united kingdom', 'france', 'german', 'italy', 'russia', 'other'];
regions['oceania'] = ['', 'other'];

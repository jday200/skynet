...
class T200HomeBlog {
    ...
    add(blog) {
        ...
        let promise = new Promise(function(resolve, reject){
            ...
            HomeStore.connect().then(function(){
                return HomeStore.execute(blog.merge_insert()).then(function(){
                    result = true;
                }, function(err){
                    debugger;
                    result = false;
    ...
    modify(blog) {
        ...
        let promise = new Promise(function(resolve, reject){
            ...
            HomeStore.connect().then(function(){
                return HomeStore.execute(blog.merge_update()).then(function(){
                    result = true;
                }, function(err){
                    result = false;
                }).finally(function(){
    ...
    get(blog) {
        ...
        let promise = new Promise(function(resolve, reject){
            ...
            HomeStore.connect().then(function(){
                return HomeStore.query(blog.merge_select_by_blog_id()).then(function(data){
    ...
    remove_all(blog) {
        ...
        let promise = new Promise(function(resolve, reject){
            ...
            HomeStore.connect().then(function(){
                return HomeStore.execute(blog.merge_delete_all()).then(function(){
                    result = true;
                }, function(err){
                    result = false;
                }).finally(function(){

...
function do_admin_login(request, response, cookie, session, resource) {
...
function do_admin_logout(request, response, cookie, session, resource) {
    log(__filename, "do_admin_logout");
    let self = this;
    let promise = new Promise(function(resolve, reject){
        let person = new T200Person();
        let HomePerson = new T200HomePerson();
...
global.action.use_post('/admin/logout', do_admin_logout);
